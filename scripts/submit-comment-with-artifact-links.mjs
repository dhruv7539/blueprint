...
//   - GITHUB_APP_PRIVATE_KEY: The private key (.pem) contents from the GitHub App settings page
...
if (process.env.GITHUB_APP_ID && process.env.GITHUB_APP_PRIVATE_KEY && process.env.GITHUB_APP_INSTALLATION_ID) {
    ...
    console.warn(
        "Required environment variables: GITHUB_APP_ID, GITHUB_APP_PRIVATE_KEY, GITHUB_APP_INSTALLATION_ID",
    );
